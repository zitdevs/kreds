import { ArrowRight, Button } from "@kreds/ui";
...
export const Tones = () => (
  <div className="flex items-center gap-6">
    <ArrowRight className="text-ink h-6 w-6" />
    <ArrowRight className="text-ink-dim h-6 w-6" />
    <ArrowRight className="text-accent h-6 w-6" />
    <ArrowRight className="text-amber h-6 w-6" />
  </div>
);
