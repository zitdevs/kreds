...
import { DocsShell, SourceNote } from "@/components/docs/docs-shell";
import { DOC_PAGES, findDoc, renderDoc } from "@/lib/docs";

/**
 * Every page is generated at build time, so the filesystem read happens once
 * during the build and never in a request. The markdown is baked into the
 * output; production serves static HTML.
 */
